...
if ($_SERVER ['HTTP_HOST'] == 'localhost')
	$root = dirname(dirname(__DIR__)); // Geht zwei Verzeichnisse nach oben
elseif ($_SERVER ['HTTP_HOST'] == 'develop.ssi.at')
	$root = "/var/www/develop/smart7/smartform";
else
	$root = "/var/www/ssi/smart7/smartform";

$path = "/examples/upload/";

// CONFIG / https://www.files.gallery/docs/config/
// Uncomment the parameters you want to edit.
return array ('root' => $root . $path,
		// 'start_path' => false,
		// 'username' => '',
		// 'password' => '',
		// 'load_images' => true,
