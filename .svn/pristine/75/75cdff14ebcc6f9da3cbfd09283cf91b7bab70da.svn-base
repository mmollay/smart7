...
$type_field = "
	$column<div class='$form_id ui $clearable $column $long selection $class_select $class_search $class_add dropdown $class_optgroup $id' id='dropdown_$id' style='$style'>
