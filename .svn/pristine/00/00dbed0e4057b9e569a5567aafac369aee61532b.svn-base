...
<head>
<meta charset="utf-8" />
<title>Bericht: <?=$array ['title']?></title>
...
<body>
	<div style='position: absolute; z-index: 1000; padding: 20px;'>
		<a class='ui icon  button' href='index.php' data-position='right center'
			data-tooltip='Zurück zur Übersicht'><i class="arrow circle left icon"></i> Übersicht</a> <a
			class='ui icon  blue button'
			onclick="call_semantic_form('','share_link','share_link.php?share_id=<?=$report_id?>','report_list','1');"
