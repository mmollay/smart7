...
$arr['th']['profit'] = [
    ...
    SELECT SUM(profit) AS sum_profit FROM ( 
        SELECT CASE WHEN SUM(o.profit) > 0 THEN SUM(o.profit) * $positiveMultiplier ELSE SUM(o.profit) * $negativeMultiplier END AS profit FROM ssi_trader.orders AS o WHERE 1
