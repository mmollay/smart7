...
$arr['list'] = array('id' => 'demo_list', 'size' => 'small', 'class' => 'compact celled striped definitio', 'class_total' => 'yellow', 'hover' => true);
...
$arr['mysql']['field'] = "*, SUM(amount) as amount";
$arr['mysql']['like'] = 'id,firstname,secondname,category,amount';
$arr['mysql']['limit'] = '20';
$arr['mysql']['export'] = 'firstname,secondname,category,amount';
$arr['mysql']['group'] = 'id'; //wenn man Summenbildung macht, braucht man ein group by
...
$arr['group'] = array("array" => array('id' => 'no groups', 'category' => 'group by Category', 'birthday' => 'group by Birthday'), 'default' => 'category');
...
$arr['th']['amount'] = array('title' => "Amount", 'align' => 'right', 'format' => 'number', 'total' => true);
