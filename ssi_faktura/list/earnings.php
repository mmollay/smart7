...
$arr['list'] = array('id' => 'bill_list', 'width' => '', 'align' => '', 'size' => 'small', 'class' => 'very compact striped selectable celled'); // definition //striped first last head foot stuck unstackable celled very compact selectable
