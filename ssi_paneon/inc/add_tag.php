...
$query = $GLOBALS['mysqli']->query ( "SELECT * FROM ssi_paneon.tag WHERE title = '$value' " );
...
if ($check) {
	...
	$GLOBALS['mysqli']->query ( "INSERT INTO ssi_paneon.tag SET title = '$value' " ) or die ( mysqli_error ($GLOBALS['mysqli']) );
